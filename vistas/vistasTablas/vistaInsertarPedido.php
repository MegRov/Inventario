...
<div class="panel-heading">
    ...
    <h3 class="panel-title">Inserción de Pedido.</h3>
</div>
<div>
    <fieldset>
        <form role="form" method="POST" action="controlador.php" id="formRegistro">
            <table>
                ...
                <tr>
                    <td>            
                        <button type="reset" name="ruta" value="cancelarInsertarPedido">Cancelar</button>&nbsp;&nbsp;||&nbsp;&nbsp;
                        <button type="submit" name="ruta" value="insertarPedido">Agregar Pedido</button>
                    </td>
                </tr>  
            </table>
