<?php
    ...
    $insertar = new proveedorDAO(SERVIDOR, BASE, USUARIO_BD, CONTRASENIA_BD);

    $insertarProveedor=$insertar->insertar($registro);

    echo "<pre>";
    print_r($insertarProveedor);
    echo "</pre>";
?>